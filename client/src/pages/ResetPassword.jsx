...
const ResetPassword = () => {
    ...
    const onSubmitNewPassword = async (e) => {
        e.preventDefault();
        try {
            const { data } = await axios.post(`${serverUrl}/api/auth/reset-password`, {
                ...
                <form onSubmit={onSubmitEmail} className='bg-slate-900 p-8 rounded-lg shadow-lg w-96 text-sm'>
                    ...
                    <div className='mb-4 flex items-center gap-3 w-full px-5 py-2.5 rounded-full bg-[#333A5C]'>
                        ...
                        <input
                            ...
                            className='bg-transparent outline-none w-[85%] text-white'
                            required />
                    </div>
                    <button className='w-full py-2.5 mt-3 bg-gradient-to-r cursor-pointer from-indigo-500 to-indigo-900 text-white rounded-full'>
                        Submit
                    </button>
                </form>
            }
                ...
                <form onSubmit={onSubmitNewPassword} className='bg-slate-900 p-8 rounded-lg shadow-lg w-96 text-sm'>
                    ...
                    <div className='mb-4 flex items-center gap-3 w-full px-5 py-2.5 rounded-full bg-[#333A5C]'>
                        ...
                        <input
                            ...
                            className='bg-transparent outline-none w-[90%] text-white'
                            required />
                    </div>
                    <button className='w-full py-2.5 mt-3 bg-gradient-to-r cursor-pointer from-indigo-500 to-indigo-900 text-white rounded-full'>
                        Submit
